      ...
      in {
        ...
        routers = {
          ...
          doh = {
            ...
            entryPoints = ["websecure"]; tls = {}; service = "doh";
          };
          sb = {
        ...
        services = {
          ...
          notebook.loadBalancer.servers = [{url = let
            attrset_find_first_infix = key: set: builtins.elemAt (lib.attrsets.attrNames set)
              (lib.lists.findFirstIndex (i: lib.strings.hasInfix key i) null (lib.attrsets.attrNames set));
            port = builtins.toString (mylib.get_uri_port
      ...
      tcp = {
        routers = {
          ...
          dot = {
            ...
            entryPoints = ["dot"]; service = "dot"; tls = {};
          };
        };
        services = {
