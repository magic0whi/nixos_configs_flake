  ...
  programs.waybar = {
    ...
    settings = [
      {
        ...
        "custom/launcher" = {
          ...
          # on-click-middle = ""; # TODO: Random wallpaper
          # on-click-right = ""; # TODO: Next wallpaper
        };
        "hyprland/workspaces" = {
          format = "{name}{windows}";
          show-special = true;
    ...
    style = ''
      ...
      */
      ...
      #keyboard-state {padding: 0; /* Remove parent box's padding */}
      #keyboard-state>label {padding: 0 5px; /* TODO HIDPI */}
      ...
      /* #mpd { */
        ...
        /* color: @text; */
      /* } */
      #mpd.disconnected {background-color: @gruvbox-red;}
      #mpd.paused {background-color: @gruvbox-gray;}
      #mpd.stopped {
        background-color: @gruvbox-fg;
        color: @gruvbox-bg;
      }

      #network.disconnected {background-color: @gruvbox-red;}
      ...
      #pulseaudio.muted {color: @gruvbox-gray;}

      #temperature.critical {background-color: @gruvbox-red;}

      #tray {background-color: @gruvbox-fg;}
      ...
      #workspaces {
        background-color: transparent;
        padding: 0; /* Remove parent box's padding */
      }
      ...
      #privacy { /* Privacy lacks class .module */
        margin-left: 2px; /* TODO HIDPI */
        margin-right: 2px; /* TODO HIDPI */
        padding: 0; /* Remove parent box's padding */
        background-color: @gruvbox-fg;
